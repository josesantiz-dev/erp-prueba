<?php
  headerAdmin($data);
getModal('GeneracionEdwin/modalNuevaGeneracion',$data);
getModal('GeneracionEdwin/modalEditGeneracion',$data);
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-5">
            ...
            <button type="button" id="BtnNuevaGeneracion" onclick="openModal();" class="btn btn-inline btn-primary btn-sm btn-block" data-toggle="modal" data-target="#modalNuevaGeneracion">><i class="fa fa-plus-circle fa-md"></i> Nuevo</button>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="card-text">
                <table id="tableGenraciones" class="table table-bordered table-striped table-hover table-sm">
                  <thead>
                  <tr>
                    <th width="7%">#</th>
